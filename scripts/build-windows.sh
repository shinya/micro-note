...
# Micro Note Windows版ビルド用シェルスクリプト
...
echo "🚀 Micro Note Windows版ビルドを開始します..."
...
echo ""
echo "📁 ビルド成果物:"
echo "   実行ファイル: src-tauri/target/x86_64-pc-windows-gnu/release/micro-note.exe"
echo "   インストーラー: src-tauri/target/x86_64-pc-windows-gnu/release/bundle/nsis/Micro Note_0.1.1_x64-setup.exe"
echo ""
echo "🎉 ビルドが正常に完了しました！"
