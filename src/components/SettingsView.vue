...
.chat-header {
  /* ヘッダーのスタイル */
              ...
              <!-- 行番号表示 -->
              <div
                class="absolute left-0 top-0 w-12 h-full bg-gray-50 border-r border-gray-200 rounded-l-xl pointer-events-none dark:bg-gray-700 dark:border-gray-600 overflow-hidden"
              >
                <div
        ...
        <div class="space-y-4">
          ...
          <div
            class="bg-gray-50 rounded-xl p-6 border border-gray-200 dark:bg-gray-800 dark:border-gray-600"
          >
            <div class="max-w-md mx-auto">
              <!-- チャットヘッダーのプレビュー -->
              <div
                class="bg-white rounded-t-xl p-4 border-b border-gray-200 chat-header"
              >
                <div class="flex items-center space-x-3">
                  <div
              ...
              <!-- 入力フィールドのプレビュー -->
              <div
                class="bg-white rounded-b-xl p-4 border-t border-gray-200 chat-input"
              >
                <div class="flex space-x-2">
                  <input
                    type="text"
...
const cssTextarea = ref(undefined)
...
const changeLanguage = event => {
  ...
  const matchingTheme = updatedThemes.find(
    theme => theme.name === currentThemeName || theme.css === customCSS.value
  )
  if (matchingTheme) {
