    ...
    <div class="max-w-4xl mx-auto h-screen flex flex-col">
      ...
      >
        <div class="p-8 space-y-6">
          <!-- メッセージ一覧 -->
          <template
            v-for="note in reverseMode
              ? [...(noteStore.notes?.value || [])].reverse()
          ...
          >
            ...
            >
              ...
              <div class="flex-1 min-w-0">
                <div
                  class="bg-white rounded-2xl px-6 py-4 shadow-lg border border-gray-100 chat-message"
                >
                  <p
          ...
          <div
            v-if="
              !noteStore.notes?.value || noteStore.notes?.value?.length === 0
            "
...
const loadMessages = async () => {
  try {
    ...
    // Error handling for loading messages
  }
}
